        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              console.log("CHECK1"); // showAlert('success', 'Logged in successfully!');

              window.setTimeout(function () {
                location.assign('/');
              }, 1500); // showAlert('success', 'Logged in successfully!');
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              location.assign('/');
              (0, _alerts.showAlert)('success', 'You are loggot!');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addNewTrip.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.searchTrip = exports.addTrip = void 0;
...
var addTrip = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(startingPoint, destination, price, passengers, startDate, startTime, description) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.data.status === 'success') {
              console.log(res.data.data.trip.id); // showAlert('success', 'Logged in successfully!');

              window.setTimeout(function () {
                location.assign("/trip/".concat(res.data.data.trip._id));
              }, 1500);
            }
  ...
  return function addTrip(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
var searchTrip = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(startingCountry, startingCity, DestinationCountry, DestinationCity) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function searchTrip(_x8, _x9, _x10, _x11) {
    return _ref2.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " has been updated!")); //   window.setTimeout(() => {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"cities.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", city[country]);
...
var _addNewTrip = require("./addNewTrip");
...
var addNewTrip = document.querySelector('.formNewTrip');
var userData = document.querySelector('.form-user-data');
var userPassword = document.querySelector('.form-user-password');
var selectFormStart = document.querySelector('.selectFormStarting');
var selectFormDestination = document.querySelector('.selectFormDestination');
var searchFormTrips = document.querySelector('.searchFormTrips');
...
if (addNewTrip) {
  console.log('test');
  document.querySelector('.formNewTrip').addEventListener('submit', function (e) {
    e.preventDefault();
    ...
    (0, _addNewTrip.addTrip)(startingPoint, destination, price, passengers, startDate, startTime, description);
  });
}
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              email = document.getElementById('email').value; // const file = document.getElementById('fileUpload').value;
...
if (selectFormStart) {
  console.log('test');
  document.querySelector('#hierarchical-country').addEventListener('change', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
      var country, select, city, opt;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              e.preventDefault();
              country = document.getElementById('hierarchical-country').value;
              document.getElementById('hierarchical-city').value = '';
              select = document.getElementById('hierarchical-city');
              ...
              _context3.next = 8;
              return (0, _cities.getCities)(country);
            ...
            case 8:
              ...
              city.forEach(function (el, index) {
...
if (selectFormDestination) {
  console.log('test');
  document.querySelector('#hierarchical-country-destination').addEventListener('change', /*#__PURE__*/function () {
      ...
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              e.preventDefault();
              country = document.getElementById('hierarchical-country-destination').value;
              document.getElementById('hierarchical-city-destination').value = '';
              select = document.getElementById('hierarchical-city-destination');
...
if (searchFormTrips) {
  document.querySelector('.searchFormTrips').addEventListener('submit', /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
      var startingCountry, startingCity, DestinationCountry, DestinationCity;
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              e.preventDefault();
              startingCountry = document.getElementById('hierarchical-country').value;
              startingCity = document.getElementById('hierarchical-city').value;
              DestinationCountry = document.getElementById('hierarchical-country-destination').value;
              DestinationCity = document.getElementById('hierarchical-city-destination').value;
              console.log(startingCountry, startingCity, DestinationCountry, DestinationCity);
              _context5.next = 8;
              return (0, _addNewTrip.searchTrip)(startingCountry, startingCity, DestinationCountry, DestinationCity);
